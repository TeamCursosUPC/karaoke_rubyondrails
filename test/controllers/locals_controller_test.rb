...
class LocalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post locals_url, params: { local: { administrador: @local.administrador, descripcion: @local.descripcion, direccion: @local.direccion, mail: @local.mail, nombre: @local.nombre, telefono: @local.telefono } }
    end
  ...
  test "should update local" do
    patch local_url(@local), params: { local: { administrador: @local.administrador, descripcion: @local.descripcion, direccion: @local.direccion, mail: @local.mail, nombre: @local.nombre, telefono: @local.telefono } }
