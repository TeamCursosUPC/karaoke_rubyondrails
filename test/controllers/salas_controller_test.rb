...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post salas_url, params: { sala: { Capacidad: @sala.Capacidad, Descripcion: @sala.Descripcion, Local: @sala.Local, Nombre_Sala: @sala.Nombre_Sala } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { Capacidad: @sala.Capacidad, Descripcion: @sala.Descripcion, Local: @sala.Local, Nombre_Sala: @sala.Nombre_Sala } }
